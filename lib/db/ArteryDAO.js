...
class ArteryDAO {
   ...
   * some additional fields from `prj_volume.artery_centreline`
...
ArteryDAO.ARTERYDATA_FIELDS = `
  ...
  LEFT JOIN counts.arteries_midblock_direction amd ON ad."ARTERYCODE" = amd.arterycode`;
