...
LocationController.push({
  ...
  options: {
    auth: { mode: 'try' },
    description: 'Get locations matching an autocomplete query',
    response: {
...
LocationController.push({
  ...
  options: {
    auth: { mode: 'try' },
    description: 'Get an encoded CompositeId of the given location(s)',
    response: {
...
LocationController.push({
  ...
  options: {
    auth: { mode: 'try' },
    description: 'Get the location(s) in the given CompositeId',
    response: {
...
LocationController.push({
  ...
  options: {
    auth: { mode: 'try' },
    description: 'Route a corridor on the given locations',
    response: {
      schema: Joi.array().items(CentrelineLocation),
    },
    tags: ['api'],
