 ...
 * @type {StringMessage}
 */
const REQUEST_STUDY_REQUIRES_REASON = {
  variant: 'warning',
  text: 'Please select the primary reason for this request.',
};
 ...
 * @type {StringMessage}
 */
const REQUEST_STUDY_REQUIRES_REASON_OTHER = {
  variant: 'warning',
  text: 'Please enter the reason for this request.',
};
...
const REQUEST_STUDY_TIME_TO_FULFILL = {
  variant: 'info',
  text: 'Standard turnaround is 2 - 3 months, but timelines may vary. Peak times are April - June and September - November.',
};
