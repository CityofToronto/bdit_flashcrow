...
class GeoStyle {
      ...
      getLayer(baseStyle, 'collisionsLevel3', 'heatmap', {
        ...
        paint: {
          ...
          'heatmap-intensity': [
            ...
            ['linear'],
            ['zoom'],
            baseStyle.sources.collisionsLevel3.minzoom, 1,
            baseStyle.sources.collisionsLevel3.maxzoom, 3,
          ],
          'heatmap-opacity': [
            'interpolate',
            ['linear'],
            ['zoom'],
            baseStyle.sources.collisionsLevel3.maxzoom, 0.8,
            baseStyle.sources.collisionsLevel3.maxzoom + 1, 0,
          ],
          'heatmap-radius': [
            'interpolate',
            ['linear'],
            ['zoom'],
            baseStyle.sources.collisionsLevel3.minzoom, 5,
            baseStyle.sources.collisionsLevel3.maxzoom, 10,
          ],
      ...
      getLayer(baseStyle, 'collisionsLevel2', 'circle', {
        ...
        paint: {
          ...
          'circle-opacity': [
            ...
            ['linear'],
            ['zoom'],
            baseStyle.sources.collisionsLevel2.minzoom, 0.2,
            baseStyle.sources.collisionsLevel2.minzoom + 1, [
              'case',
              ['>=', ['get', 'injury'], 3], 0.8,
              0.6,
            ],
  ...
  static getCountsLayers({ layers: { counts } }, baseStyle) {
    const visibility = counts ? 'visible' : 'none';
    return [
      getLayer(baseStyle, 'counts', 'circle', {
        layout: {
          visibility,
        },
        paint: {
