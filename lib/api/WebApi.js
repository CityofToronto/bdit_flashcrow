...
async function fetchStudyRequestsMetadata(studyRequests) {
...
async function getStudyRequest(id) {
  ...
  const {
    studyRequestLocations,
    studyRequestUsers,
  } = await fetchStudyRequestsMetadata([studyRequest]);
...
async function getStudyRequestBulk(id) {
  ...
  studyRequestBulk = await StudyRequestBulk.validateAsync(studyRequestBulk);
...
async function getStudyRequests() {
  ...
  const metadata = await fetchStudyRequestsMetadata(studyRequests);
  return {
    studyRequests,
    ...metadata,
  };
