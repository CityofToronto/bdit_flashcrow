...
class MovePdfGenerator {
  ...
  static getNotesBlock(notes) {
    if (notes === null) {
      return { text: 'No additional notes.' };
    }
    return {
      text: [
        { text: 'Additional Notes: ', bold: true },
        notes,
      ],
    };
  }
  ...
  /* eslint-disable class-methods-use-this */
  generateCountMetadata({ left, right, notes }) {
    ...
    const notesBlock = MovePdfGenerator.getNotesBlock(notes);
    return [countMetadataBlock, notesBlock];
  }
