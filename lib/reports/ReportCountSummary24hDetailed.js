    ...
    return {
      ...
      body: ArrayUtils.range(24).map((h) => {
        ...
        return [
          ...
          { value: reportData[i].count, style: { br: true, shade: h % 2 === 1 } },
          { value: reportData[i + 1].count, style: { br: true, shade: h % 2 === 1 } },
          { value: reportData[i + 2].count, style: { br: true, shade: h % 2 === 1 } },
          { value: reportData[i + 3].count, style: { shade: h % 2 === 1 } },
        ];
      }),
    };
  }
