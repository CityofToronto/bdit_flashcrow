...
class ReportBaseFlow extends ReportBase {
  ...
  static getCountMetadataBlock({
    ...
    const options = {
      entries: [
        { cols: 3, name: 'Location', value: locationDesc },
        { cols: 3, name: 'Date', value: dateValue },
        { cols: 6, name: 'Study Category', value: studyType.label },
        { cols: 3, name: 'Station Code', value: stationCode },
        { cols: 3, name: 'Artery Code', value: arteryCode },
