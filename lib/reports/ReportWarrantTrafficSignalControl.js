...
class ReportWarrantTrafficSignalControl extends ReportBaseFlowDirectional {
    ...
    return {
      ...
      body: [
        [
          ...
          {
            value: FORMAT_PREVENTABLES_AVERAGE(sectionData.value.avg),
            style: { bl: true },
          },
  ...
  generateLayoutContent(count, reportData) {
    ...
    const section3CTableOptions = ReportWarrantTrafficSignalControl.getBooleanTableOptions(
      null,
      `3C. Either warrant 1 or 2 at least ${COMPLIANCE_PARTIAL}% met?`,
      reportData.collisionHazard.c,
    );
    ...
    return [
      ...
      { type: ReportBlock.TABLE, options: section3CTableOptions },
