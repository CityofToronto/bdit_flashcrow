...
class ReportWarrantTrafficSignalControl extends ReportBaseFlowDirectional {
  ...
  static getThresholds(options) {
    ...
    return {
       ...
       */
      threshold3A: {
        threshold3AAnnualSeverity: ReportWarrantTrafficSignalControl.THRESHOLD_3A_ANNUAL_SEVERITY,
        threshold3AAnnualKsi: ReportWarrantTrafficSignalControl.THRESHOLD_3A_ANNUAL_KSI,
        threshold3ATotalSeverity: ReportWarrantTrafficSignalControl.THRESHOLD_3A_TOTAL_SEVERITY,
        threshold3ATotalKsi: ReportWarrantTrafficSignalControl.THRESHOLD_3A_TOTAL_KSI,
      },
    };
  }
    ...
    return {
      ...
      body: [
        ...
        [
          ...
          {
            value: ReportWarrantTrafficSignalControl.THRESHOLD_3A_TOTAL_SEVERITY,
            style: { bt: true },
          },
          {
            value: reportData.collisionHazard.a.total3ASeverity
            / ReportWarrantTrafficSignalControl.THRESHOLD_3A_TOTAL_SEVERITY * 100,
            style: { bl: true, bt: true },
          },
          {
            value: reportData.collisionHazard.a.total3ASeverity
  ...
  static getPreventableCollisionsTableOptions(sectionData) {
    ...
    return {
      ...
      header: [
        [
          { value: ' ' },
          { value: `Year 1 (${startDateRanges[0]})` },
          { value: ' ' },
      ...
      body: [
        ...
        [
          { value: 'Minimum Required (Based on 8H volume of 2,500-4,000)' },
          { value: ReportWarrantTrafficSignalControl.THRESHOLD_3A_ANNUAL_SEVERITY },
          { value: ReportWarrantTrafficSignalControl.THRESHOLD_3A_ANNUAL_KSI },
          { value: ReportWarrantTrafficSignalControl.THRESHOLD_3A_ANNUAL_SEVERITY },
          { value: ReportWarrantTrafficSignalControl.THRESHOLD_3A_ANNUAL_KSI },
          { value: ReportWarrantTrafficSignalControl.THRESHOLD_3A_ANNUAL_SEVERITY },
          { value: ReportWarrantTrafficSignalControl.THRESHOLD_3A_ANNUAL_KSI },
          { value: ReportWarrantTrafficSignalControl.THRESHOLD_3A_TOTAL_SEVERITY },
          { value: ReportWarrantTrafficSignalControl.THRESHOLD_3A_TOTAL_KSI },
        ],
        [
          { value: '100% Fulfilled (any one value must meet/exceed the minimum for justification)' },
          sectionData.severityCompliance[0] === 100 ? { value: '' } : { value: ' ', style: { br: true } },
          sectionData.ksiCompliance[0] === 100 ? { value: '' } : { value: ' ', style: { br: true } },
          sectionData.severityCompliance[1] === 100 ? { value: '' } : { value: ' ', style: { br: true } },
          sectionData.ksiCompliance[1] === 100 ? { value: '' } : { value: ' ', style: { br: true } },
          sectionData.severityCompliance[2] === 100 ? { value: '' } : { value: ' ', style: { br: true } },
          sectionData.ksiCompliance[2] === 100 ? { value: '' } : { value: ' ', style: { br: true } },
          sectionData.severityCompliance[3] === 100 ? { value: '' } : { value: ' ', style: { br: true } },
          sectionData.ksiCompliance[3] === 100 ? { value: '' } : { value: ' ', style: { br: true } },
        ],
        [
          { value: 'Actual % (if < 100%)' },
          sectionData.severityCompliance[0] < 100 ? { value: `${sectionData.severityCompliance[0]}%` } : { value: ' ' },
          sectionData.ksiCompliance[0] < 100 ? { value: `${sectionData.ksiCompliance[0]}%` } : { value: ' ' },
          sectionData.severityCompliance[1] < 100 ? { value: `${sectionData.severityCompliance[1]}%` } : { value: ' ' },
          sectionData.ksiCompliance[1] < 100 ? { value: `${sectionData.ksiCompliance[1]}%` } : { value: ' ' },
          sectionData.severityCompliance[2] < 100 ? { value: `${sectionData.severityCompliance[2]}%` } : { value: ' ' },
          sectionData.ksiCompliance[2] < 100 ? { value: `${sectionData.ksiCompliance[2]}%` } : { value: ' ' },
          sectionData.severityCompliance[3] < 100 ? { value: `${sectionData.severityCompliance[3]}%` } : { value: ' ' },
          sectionData.ksiCompliance[3] < 100 ? { value: `${sectionData.ksiCompliance[3]}%` } : { value: ' ' },
        ],
      ],
    };
  }
 ...
 * @type {number}
 */
ReportWarrantTrafficSignalControl.THRESHOLD_3A_ANNUAL_SEVERITY = 5;
/**
 * @type {number}
 */
ReportWarrantTrafficSignalControl.THRESHOLD_3A_ANNUAL_KSI = 3;

/**
 * @type {number}
 */
ReportWarrantTrafficSignalControl.THRESHOLD_3A_TOTAL_SEVERITY = 6;
/**
 * @type {number}
 */
ReportWarrantTrafficSignalControl.THRESHOLD_3A_TOTAL_KSI = 4;
