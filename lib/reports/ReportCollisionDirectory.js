...
class ReportCollisionDirectory extends ReportBaseCrash {
  ...
  getTableOptions(collisions) {
    return {
      tableStyle: { fontSize: 'xs', inlineTable: true },
      inlineTable: true,
      header: [
        [
          { value: 'MVCR', colspan: 3, style: { br: true } }, // MVCR section
          { value: null },
          { value: null },
          { value: 'Collision' },
          { value: 'Traffic' },
          ...
          { value: 'Involved', colspan: 3, style: { bl: true, br: true } },
          { value: 'Injuries', colspan: 6, style: { br: true } },
          { value: null },
        ], [
          { value: 'Report' }, // d/l button
          { value: 'Number' }, // MVCR Num
          { value: 'Source', style: { br: true } }, // Data src
          { value: 'Date' },
          { value: 'Time' },
          { value: 'Class' },
          { value: 'Control' },
          ...
          { value: 'Age' },
          // counts (#)
          { value: 'Driv', style: { bl: true } },
          { value: 'Ped' },
          { value: 'Cyc', style: { br: true } },
          // injury
          { value: 'None' }, // NO
          { value: 'Minimal' }, // MI
          { value: 'Minor' }, // MR
