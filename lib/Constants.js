...
bridge supports, buildings, trees, etc.); or</li>
  ...
  RED_LIGHT: {
    ...
    tooltip: `
<span>Collisions where the traffic control is a traffic signal, and where:</span>
<ul>
  <li>the driver disobeyed the traffic control; or</li>
...
<ul>
  ...
  <li>disobeyed the traffic control; or</li>
  <li>failed to yield the right-of-way; or</li>
  <li>drove too fast for the conditions; or</li>
  <li>passed incorrectly.</li>
</ul>`,
  },
  CYCLISTS: {
    field: 'cyclist',
  ...
  MOTORCYCLISTS: {
    field: 'motorcyclist',
    text: 'Motorcyclists',
    tooltip: '<span>Collisions where at least one motorcycle or moped was involved.</span>',
  },
  OLDER_ADULTS: {
    field: 'older_adult',
    text: 'Older Adults',
    tooltip: '<span>Collisions where at least one person involved was 55 or over.</span>',
  },
  SCHOOL_CHILDREN: {
    field: 'school_child',
    text: 'School Children',
    tooltip: `
<span>Collisions where at least one child of school age (4-19) was involved, and that:</span>
<ul>
  <li>took place during school months (Sep-Jun);</li>
  <li>took place on a school day (Mon-Fri).</li>
</ul>`,
  },
});
