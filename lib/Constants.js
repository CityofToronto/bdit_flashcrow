...
StudyType.init({
  ...
  ATR_SVC: {
    ...
    other: false,
    hourOptions: null,
    subtitle: 'Counts motor vehicle volumes along a roadway and classifies by speed and vehicle type',
  },
  ATR_VOLUME: {
    label: 'Volume ATR',
    isMultiDay: true,
  ...
  ATR_VOLUME_BICYCLE: {
    ...
    other: false,
    hourOptions: null,
    subtitle: 'Counts bicycles on dedicated bike infrastructure',
  },
  OTHER: {
    label: 'Other',
    isMultiDay: false,
    ...
    other: true,
    hourOptions: ['OTHER'],
    subtitle: 'Other studies to observe specific traffic behaviour (e.g. left-turn, queue-delay, origin-destination, parking occupancy, radar gun)',
  },
  PED_DELAY: {
    ...
    subtitle: 'Counts pedestrians crossing a street, classifies them by type, and notes the time they waited to cross',
  },
  PXO_OBSERVE: {
    ...
    other: false,
    hourOptions: ['ROUTINE', 'SCHOOL', 'OTHER'],
    subtitle: 'Counts pedestrians using a crosswalk and observes vehicle and pedestrian behaviour',
  },
  RESCU: {
  ...
  TMC: {
    ...
    other: false,
    hourOptions: ['ROUTINE', 'SCHOOL', 'OTHER'],
    subtitle: 'Counts vehicles, bicycles, pedestrians and their movements at intersections',
  },
  VEHICLE_CLASS: {
  ...
  MULTI_MODAL: {
    ...
    subtitle: 'Counts all modes of traffic along a roadway',
  },
  VID_OBSERVE: {
    ...
    other: false,
    hourOptions: ['DAYLIGHT', 'OTHER'],
    subtitle: 'Video observation of traffic behaviour',
  },
  SCHOOL_CROSS: {
    ...
    subtitle: 'Counts vehicles, bicycles, pedestrians and their turning movements at intersections, with pedestrian classification',
  },
  GAP_STUDY: {
    label: 'Gap Study',
    isMultiDay: false,
    ...
    subtitle: 'Measures the time gap between vehicles travelling on a roadway. Usually done with a School Crossing Guard Study.',
  },
});
