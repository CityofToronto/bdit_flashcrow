...
ReportType.init({
  ...
  WARRANT_TRAFFIC_SIGNAL_CONTROL: {
    ...
    options: {
      ...
      allSeverities: ReportParameter.ALL_SEVERITIES,
      allKsi: ReportParameter.KSI,
...
StudyType.init({
  ...
  ATR_SVC: {
    ...
    other: false,
    hourOptions: null,
    subtitle: 'Counts motor vehicle volumes at midblock locations and classifies by speed and vehicle type',
  },
  ATR_VOLUME: {
    label: 'Volume ATR',
    isMultiDay: true,
  ...
  BIKE_COUNT: {
    ...
    other: false,
    hourOptions: null,
    subtitle: 'Counts micromobility users at midblock locations or trail crossings and classifies by type of facility used',
  },
  OTHER: {
    label: 'Other',
    isMultiDay: false,
    ...
    other: true,
    hourOptions: ['OTHER'],
    subtitle: 'Other studies to observe specific traffic behaviour. For example, left-turn, queue-delay, origin-destination, parking occupancy, radar gun.',
  },
  PED_DELAY: {
    label: 'Pedestrian Delay Study',
    isMultiDay: false,
    beta: {
      description: '2015 to 2020 data only',
      descriptionLarge: 'Counts pedestrians crossing a street, the time they wait before crossing, and classifies by age and mobility. Can only be done at uncontrolled crossings.',
    },
    dataAvailable: true,
    maskStudy: true,
    dataType: ReportDataType.PED_DELAY,
    ...
    subtitle: 'Counts pedestrians crossing a street, classifies by age and mobility, and time waited before crossing. Can only be done at uncontrolled locations.',
  },
  PXO_OBSERVE: {
    ...
    other: false,
    hourOptions: ['ROUTINE', 'SCHOOL', 'OTHER'],
    subtitle: 'Counts pedestrians using a Pedestrian Crossover (PXO), vehicles present for each crossing, and vehicle and pedestrian behaviour',
  },
  RESCU: {
  ...
  TMC: {
    ...
    other: false,
    hourOptions: ['ROUTINE', 'SCHOOL', 'OTHER'],
    subtitle: 'Counts vehicles, bicycles, and pedestrians and classifies their movements as they pass through an intersection',
  },
  VEHICLE_CLASS: {
  ...
  MULTI_MODAL: {
    label: 'Midblock Multi-Modal Count',
    isMultiDay: false,
    beta: {
      description: 'Counts all modes of transportation at midblock locations and classifies by vehicle type. Does not sub-classify micromobility types.',
      descriptionLarge: 'Counts all modes of transportation at midblock locations and classifies by vehicle type. Does not sub-classify micromobility types.',
    },
    dataAvailable: false,
    maskStudy: false,
    dataType: ReportDataType.MULTI_MODAL,
    hourOptions: ['DAYLIGHT', 'OTHER'],
    subtitle: 'Counts all modes of transportation at midblock locations and classifies by vehicle type. Does not sub-classify micromobility types.',
  },
  VID_OBSERVE: {
    ...
    other: false,
    hourOptions: ['DAYLIGHT', 'OTHER'],
    subtitle: 'Video recording of the public right-of-way. You will receive the video recording only.',
  },
  SCHOOL_CROSS: {
    ...
    subtitle: 'Counts vehicles, bicycles, and pedestrians and classifies their movements as they pass through an intersection. Counts the number of children (4-12) crossing.',
  },
  GAP_STUDY: {
    label: 'Gap Study',
    isMultiDay: false,
    ...
    subtitle: 'Measures the time gap between vehicles at midblock locations. Usually done together with a School Crossing Guard Study.',
  },
  PED_CLASS: {
    label: 'Pedestrian Classification Count',
    isMultiDay: false,
    beta: null,
    dataAvailable: false,
    maskStudy: true,
    other: false,
    hourOptions: ['ROUTINE', 'SCHOOL', 'DAYLIGHT', 'OTHER'],
    subtitle: 'Counts pedestrians at midblock locations, intersections, or crossings, and classifies by age and mobility. Does not record delay to cross.',
  },
  PED_COUNT: {
    ...
    other: false,
    hourOptions: null,
    subtitle: 'Counts pedestrians at midblock locations or trail crossings',
  },
  BIKE_CLASS: {
    label: 'Bicycle Classification Count',
    isMultiDay: false,
    beta: null,
    dataAvailable: false,
    maskStudy: false,
    other: false,
    hourOptions: ['ROUTINE', 'SCHOOL', 'DAYLIGHT', 'OTHER'],
    subtitle: 'Counts micromobility users at midblock locations or trail crossings and classifies by vehicle type and type of facility used',
  },
});
...
const REPORT_CONSTANTS = {
  ...
  TWO_HOUR_PEAK_DURATION: { hours: 2 },
  AM_PEAK_WINDOW: {
