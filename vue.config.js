...
const vueConfig = {
  ...
  devServer: {
    headers: {
       ...
       *   production.
       */
      'Content-Security-Policy': "default-src 'self'; connect-src 'self' basemaps.arcgis.com dc.oracleinfinity.io gis.toronto.ca move.intra.dev-toronto.ca; img-src 'self' data:; object-src 'none'; script-src 'self' 'sha256-Ix3D5FOcUFYthhmMKpYmohXJnGWIKZgEqg6dVkA/8TQ=' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; worker-src 'self' blob:",
    },
