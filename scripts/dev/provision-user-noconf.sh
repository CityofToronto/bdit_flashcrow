...
#
# This script should *not* rely on values from provision.conf.yml.  If you
# have commands that require credentials stored there, add them to
# provision-user.sh.
...
# We run .bashrc here to make sure that pyenv, nvm are accessible in the shell.
