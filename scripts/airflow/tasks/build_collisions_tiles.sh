...
tippecanoe --progress-interval=10 --force -o /data/tiles/collisionsLevel3.mbtiles -l collisionsLevel3 -Z10 -z16 --accumulate-attribute=heatmap_weight:sum --cluster-densest-as-needed -r1 /data/tiles/collisionsLevel3.json
tippecanoe --progress-interval=10 --force -o /data/tiles/collisionsLevel2.mbtiles -l collisionsLevel2 -Z14 -z16 /data/tiles/collisionsLevel2.json
